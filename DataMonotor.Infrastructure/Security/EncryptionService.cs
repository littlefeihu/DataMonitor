...
namespace DataMonitor.DQ.Infrastructure.Security
{
    public class EncryptionService
    {
        ...
        public static string EncryptText(string plainText, string encryptionPrivateKey = Constants.DEFAULT_SECURITY_KEY)
        {
        ...
        public static string DecryptText(string cipherText, string encryptionPrivateKey = Constants.DEFAULT_SECURITY_KEY)
        {
